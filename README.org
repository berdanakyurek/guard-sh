...
Checks all configured providers — validates API keys and model names without spending any tokens.

#+begin_example
  guard-sh healthcheck

  openai      gpt-4o-mini                          ● ok
  gemini      gemini-3.1-flash-lite-preview        ● ok
  deepseek    deepseek-chat                        ✗ HTTP 401: Authentication Fails
  claude      claude-haiku-4-5-20251001            ● ok
#+end_example
